"""
Conftest for style domain tests.

Pre-loads the installed `mcp` package before pytest adds the local
...
if "mcp" not in sys.modules:
    _clean_path = [p for p in sys.path if "LV_Presentation/domains/style" not in p]
