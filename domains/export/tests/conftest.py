"""
Conftest for export domain tests.
...
if "mcp" not in sys.modules:
    _clean_path = [p for p in sys.path if "LV_Presentation/domains/export" not in p]
    ...
    if _mcp_spec is not None:
        ...
        _mcp_spec.loader.exec_module(_mcp_module)  # type: ignore[union-attr]
